  ...
  socket => {
    ...
    socket.on(
      ...
      username => {
        ...
        // también desaparece de tus contactos
        list[index].contacts =
          (
            list[index]
              .contacts ||
